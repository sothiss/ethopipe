  ...
  - repo: local
    hooks:
      ...
      - id: validate-prompts
        ...
        language: system
        files: src/pipeline/prompts\.py|src/pipeline/models\.py
        types: [file]
      ...
      - id: detect-debug-logs
        ...
        language: system
        files: src/pipeline/main\.py|src/pipeline/api\.py
        types: [file]
        stages: [pre-commit, pre-push]
