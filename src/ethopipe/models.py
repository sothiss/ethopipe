...
BEHAVIOR_ONTOLOGY_MAPPING = {
    ...
    "trembling": "http://purl.obolibrary.org/obo/NBO_0000589",
    "pacing": "http://purl.obolibrary.org/obo/NBO_0000622",
...
class EthologicalObservation(BaseModel):
    ...
    dog_size_category: Optional[
        Literal["Toy", "Small", "Medium", "Large", "Giant", "Puppy"]
    ] = Field(
        None,
    ...
    latitude: Optional[float] = Field(
        None, description="Maps to dwc:decimalLatitude in decimal degrees [5-8]."
    )
    longitude: Optional[float] = Field(
        None, description="Maps to dwc:decimalLongitude in decimal degrees [5-7, 9]."
    )
    ...
    heart_rate_unit: Literal["BPM"] = Field(
        "BPM", description="Maps to dwc:measurementUnit [6, 20]."
    )
    ...
    temp_unit: Literal["°C"] = Field(
        "°C", description="Maps to dwc:measurementUnit [6, 20]."
    )
    ...
    cortisol_unit: Literal["ng/mL"] = Field(
        "ng/mL", description="Maps to dwc:measurementUnit for cortisol levels."
    )
    cortisol_matrix: Optional[
        Literal["blood", "serum", "plasma", "saliva", "urine", "hair", "feces", "claws"]
    ] = Field(
        None,
    ...
    def resolve_behavior_type_id(self) -> "EthologicalObservation":
        if (
            self.behavior_type_id is None or self.behavior_type_id == ""
        ) and self.behavior_type is not None:
...
class QuarantineRecord(BaseModel):
    ...
    original_index: Optional[int] = Field(
        None, description="1-based index or line number in the source file/batch."
    )
