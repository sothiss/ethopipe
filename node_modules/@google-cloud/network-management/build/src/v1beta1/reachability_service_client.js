...
exports.ReachabilityServiceClient = void 0;
 ...
 */
const gapicConfig = require("./reachability_service_client_config.json");
...
class ReachabilityServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listConnectivityTests: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'resources')
        };
        ...
        const createConnectivityTestResponse = protoFilesRoot.lookup('.google.cloud.networkmanagement.v1beta1.ConnectivityTest');
        const createConnectivityTestMetadata = protoFilesRoot.lookup('.google.cloud.networkmanagement.v1beta1.OperationMetadata');
        const updateConnectivityTestResponse = protoFilesRoot.lookup('.google.cloud.networkmanagement.v1beta1.ConnectivityTest');
        const updateConnectivityTestMetadata = protoFilesRoot.lookup('.google.cloud.networkmanagement.v1beta1.OperationMetadata');
        const rerunConnectivityTestResponse = protoFilesRoot.lookup('.google.cloud.networkmanagement.v1beta1.ConnectivityTest');
        const rerunConnectivityTestMetadata = protoFilesRoot.lookup('.google.cloud.networkmanagement.v1beta1.OperationMetadata');
        const deleteConnectivityTestResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteConnectivityTestMetadata = protoFilesRoot.lookup('.google.cloud.networkmanagement.v1beta1.OperationMetadata');
        this.descriptors.longrunning = {
            createConnectivityTest: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createConnectivityTestResponse.decode.bind(createConnectivityTestResponse), createConnectivityTestMetadata.decode.bind(createConnectivityTestMetadata)),
            updateConnectivityTest: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateConnectivityTestResponse.decode.bind(updateConnectivityTestResponse), updateConnectivityTestMetadata.decode.bind(updateConnectivityTestMetadata)),
            rerunConnectivityTest: new this._gaxModule.LongrunningDescriptor(this.operationsClient, rerunConnectivityTestResponse.decode.bind(rerunConnectivityTestResponse), rerunConnectivityTestMetadata.decode.bind(rerunConnectivityTestMetadata)),
            deleteConnectivityTest: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteConnectivityTestResponse.decode.bind(deleteConnectivityTestResponse), deleteConnectivityTestMetadata.decode.bind(deleteConnectivityTestMetadata))
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.networkmanagement.v1beta1.ReachabilityService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.reachabilityServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.networkmanagement.v1beta1.ReachabilityService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.networkmanagement.v1beta1.ReachabilityService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const reachabilityServiceStubMethods = ['listConnectivityTests', 'getConnectivityTest', 'createConnectivityTest', 'updateConnectivityTest', 'rerunConnectivityTest', 'deleteConnectivityTest'];
        for (const methodName of reachabilityServiceStubMethods) {
            const callPromise = this.reachabilityServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getConnectivityTest(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    createConnectivityTest(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkCreateConnectivityTestProgress(name) {
    ...
    updateConnectivityTest(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkUpdateConnectivityTestProgress(name) {
    ...
    rerunConnectivityTest(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkRerunConnectivityTestProgress(name) {
    ...
    deleteConnectivityTest(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkDeleteConnectivityTestProgress(name) {
    ...
    listConnectivityTests(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listConnectivityTestsStream(request, options) {
        ...
        return this.descriptors.page.listConnectivityTests.createStream(this.innerApiCalls.listConnectivityTests, request, callSettings);
    }
    /**
    ...
    listConnectivityTestsAsync(request, options) {
        ...
        return this.descriptors.page.listConnectivityTests.asyncIterate(this.innerApiCalls['listConnectivityTests'], request, callSettings);
    }
    /**
...
exports.ReachabilityServiceClient = ReachabilityServiceClient;
//# sourceMappingURL=reachability_service_client.js.map