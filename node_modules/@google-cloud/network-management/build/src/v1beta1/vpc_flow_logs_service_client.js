...
exports.VpcFlowLogsServiceClient = void 0;
 ...
 */
const gapicConfig = require("./vpc_flow_logs_service_client_config.json");
 ...
 * @memberof v1beta1
 */
class VpcFlowLogsServiceClient {
    _terminated = false;
    _opts;
    ...
    _universeDomain;
    _servicePath;
    _log = google_gax_1.loggingUtils.log('network-management');
    auth;
    descriptors = {
        page: {},
        stream: {},
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            connectivityTestPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/global/connectivityTests/{test}'),
            locationPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}'),
            organizationLocationVpcFlowLogsConfigsPathTemplate: new this._gaxModule.PathTemplate('organizations/{organization}/locations/{location}/vpcFlowLogsConfigs/{vpc_flow_logs_config}'),
            projectPathTemplate: new this._gaxModule.PathTemplate('projects/{project}'),
            projectLocationVpcFlowLogsConfigsPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/vpcFlowLogsConfigs/{vpc_flow_logs_config}'),
        };
        // Some of the methods on this service return "paged" results,
        // (e.g. 50 results at a time, with tokens to get subsequent
        // pages). Denote the keys used for pagination and results.
        this.descriptors.page = {
            listVpcFlowLogsConfigs: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'vpcFlowLogsConfigs'),
            queryOrgVpcFlowLogsConfigs: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'vpcFlowLogsConfigs'),
            showEffectiveFlowLogsConfigs: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'effectiveFlowLogsConfigs')
        };
        ...
        const createVpcFlowLogsConfigResponse = protoFilesRoot.lookup('.google.cloud.networkmanagement.v1beta1.VpcFlowLogsConfig');
        const createVpcFlowLogsConfigMetadata = protoFilesRoot.lookup('.google.cloud.networkmanagement.v1beta1.OperationMetadata');
        const updateVpcFlowLogsConfigResponse = protoFilesRoot.lookup('.google.cloud.networkmanagement.v1beta1.VpcFlowLogsConfig');
        const updateVpcFlowLogsConfigMetadata = protoFilesRoot.lookup('.google.cloud.networkmanagement.v1beta1.OperationMetadata');
        const deleteVpcFlowLogsConfigResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteVpcFlowLogsConfigMetadata = protoFilesRoot.lookup('.google.cloud.networkmanagement.v1beta1.OperationMetadata');
        this.descriptors.longrunning = {
            createVpcFlowLogsConfig: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createVpcFlowLogsConfigResponse.decode.bind(createVpcFlowLogsConfigResponse), createVpcFlowLogsConfigMetadata.decode.bind(createVpcFlowLogsConfigMetadata)),
            updateVpcFlowLogsConfig: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateVpcFlowLogsConfigResponse.decode.bind(updateVpcFlowLogsConfigResponse), updateVpcFlowLogsConfigMetadata.decode.bind(updateVpcFlowLogsConfigMetadata)),
            deleteVpcFlowLogsConfig: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteVpcFlowLogsConfigResponse.decode.bind(deleteVpcFlowLogsConfigResponse), deleteVpcFlowLogsConfigMetadata.decode.bind(deleteVpcFlowLogsConfigMetadata))
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.networkmanagement.v1beta1.VpcFlowLogsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.vpcFlowLogsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.networkmanagement.v1beta1.VpcFlowLogsService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.networkmanagement.v1beta1.VpcFlowLogsService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const vpcFlowLogsServiceStubMethods = ['listVpcFlowLogsConfigs', 'getVpcFlowLogsConfig', 'createVpcFlowLogsConfig', 'updateVpcFlowLogsConfig', 'deleteVpcFlowLogsConfig', 'queryOrgVpcFlowLogsConfigs', 'showEffectiveFlowLogsConfigs'];
        for (const methodName of vpcFlowLogsServiceStubMethods) {
            const callPromise = this.vpcFlowLogsServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getVpcFlowLogsConfig(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    createVpcFlowLogsConfig(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkCreateVpcFlowLogsConfigProgress(name) {
    ...
    updateVpcFlowLogsConfig(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkUpdateVpcFlowLogsConfigProgress(name) {
    ...
    deleteVpcFlowLogsConfig(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkDeleteVpcFlowLogsConfigProgress(name) {
    ...
    listVpcFlowLogsConfigs(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listVpcFlowLogsConfigsStream(request, options) {
        ...
        return this.descriptors.page.listVpcFlowLogsConfigs.createStream(this.innerApiCalls.listVpcFlowLogsConfigs, request, callSettings);
    }
    /**
    ...
    listVpcFlowLogsConfigsAsync(request, options) {
        ...
        return this.descriptors.page.listVpcFlowLogsConfigs.asyncIterate(this.innerApiCalls['listVpcFlowLogsConfigs'], request, callSettings);
    }
    queryOrgVpcFlowLogsConfigs(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   for more details and examples.
     */
    queryOrgVpcFlowLogsConfigsStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.queryOrgVpcFlowLogsConfigs.createStream(this.innerApiCalls.queryOrgVpcFlowLogsConfigs, request, callSettings);
    }
    /**
     ...
     */
    queryOrgVpcFlowLogsConfigsAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.queryOrgVpcFlowLogsConfigs.asyncIterate(this.innerApiCalls['queryOrgVpcFlowLogsConfigs'], request, callSettings);
    }
    showEffectiveFlowLogsConfigs(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   for more details and examples.
     */
    showEffectiveFlowLogsConfigsStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.showEffectiveFlowLogsConfigs.createStream(this.innerApiCalls.showEffectiveFlowLogsConfigs, request, callSettings);
    }
    /**
     ...
     */
    showEffectiveFlowLogsConfigsAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.showEffectiveFlowLogsConfigs.asyncIterate(this.innerApiCalls['showEffectiveFlowLogsConfigs'], request, callSettings);
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    organizationLocationVpcFlowLogsConfigsPath(organization, location, vpcFlowLogsConfig) {
     ...
     */
    matchOrganizationFromOrganizationLocationVpcFlowLogsConfigsName(organizationLocationVpcFlowLogsConfigsName) {
     ...
     * @returns {string} A string representing the location.
     */
    matchLocationFromOrganizationLocationVpcFlowLogsConfigsName(organizationLocationVpcFlowLogsConfigsName) {
     ...
     */
    matchVpcFlowLogsConfigFromOrganizationLocationVpcFlowLogsConfigsName(organizationLocationVpcFlowLogsConfigsName) {
     ...
     * @returns {string} Resource name string.
     */
    projectLocationVpcFlowLogsConfigsPath(project, location, vpcFlowLogsConfig) {
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromProjectLocationVpcFlowLogsConfigsName(projectLocationVpcFlowLogsConfigsName) {
     ...
     * @returns {string} A string representing the location.
     */
    matchLocationFromProjectLocationVpcFlowLogsConfigsName(projectLocationVpcFlowLogsConfigsName) {
     ...
     * @returns {string} A string representing the vpc_flow_logs_config.
     */
    matchVpcFlowLogsConfigFromProjectLocationVpcFlowLogsConfigsName(projectLocationVpcFlowLogsConfigsName) {
...
exports.VpcFlowLogsServiceClient = VpcFlowLogsServiceClient;
//# sourceMappingURL=vpc_flow_logs_service_client.js.map