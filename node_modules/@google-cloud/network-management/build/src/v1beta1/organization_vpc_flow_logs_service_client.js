...
exports.OrganizationVpcFlowLogsServiceClient = void 0;
 ...
 */
const gapicConfig = require("./organization_vpc_flow_logs_service_client_config.json");
...
class OrganizationVpcFlowLogsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.networkmanagement.v1beta1.OrganizationVpcFlowLogsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.organizationVpcFlowLogsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.networkmanagement.v1beta1.OrganizationVpcFlowLogsService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.networkmanagement.v1beta1.OrganizationVpcFlowLogsService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const organizationVpcFlowLogsServiceStubMethods = ['listVpcFlowLogsConfigs', 'getVpcFlowLogsConfig', 'createVpcFlowLogsConfig', 'updateVpcFlowLogsConfig', 'deleteVpcFlowLogsConfig'];
        for (const methodName of organizationVpcFlowLogsServiceStubMethods) {
            const callPromise = this.organizationVpcFlowLogsServiceStub.then(stub => (...args) => {
                if (this._terminated) {
...
exports.OrganizationVpcFlowLogsServiceClient = OrganizationVpcFlowLogsServiceClient;
//# sourceMappingURL=organization_vpc_flow_logs_service_client.js.map