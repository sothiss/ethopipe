...
class VpcFlowLogsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createVpcFlowLogsConfigResponse = protoFilesRoot.lookup('.google.cloud.networkmanagement.v1.VpcFlowLogsConfig');
        const createVpcFlowLogsConfigMetadata = protoFilesRoot.lookup('.google.cloud.networkmanagement.v1.OperationMetadata');
        const updateVpcFlowLogsConfigResponse = protoFilesRoot.lookup('.google.cloud.networkmanagement.v1.VpcFlowLogsConfig');
        const updateVpcFlowLogsConfigMetadata = protoFilesRoot.lookup('.google.cloud.networkmanagement.v1.OperationMetadata');
        const deleteVpcFlowLogsConfigResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteVpcFlowLogsConfigMetadata = protoFilesRoot.lookup('.google.cloud.networkmanagement.v1.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.networkmanagement.v1.VpcFlowLogsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.vpcFlowLogsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.networkmanagement.v1.VpcFlowLogsService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.networkmanagement.v1.VpcFlowLogsService, this._opts, this._providedCustomServicePath);
