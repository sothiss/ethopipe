...
class ReachabilityServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createConnectivityTestResponse = protoFilesRoot.lookup('.google.cloud.networkmanagement.v1.ConnectivityTest');
        const createConnectivityTestMetadata = protoFilesRoot.lookup('.google.cloud.networkmanagement.v1.OperationMetadata');
        const updateConnectivityTestResponse = protoFilesRoot.lookup('.google.cloud.networkmanagement.v1.ConnectivityTest');
        const updateConnectivityTestMetadata = protoFilesRoot.lookup('.google.cloud.networkmanagement.v1.OperationMetadata');
        const rerunConnectivityTestResponse = protoFilesRoot.lookup('.google.cloud.networkmanagement.v1.ConnectivityTest');
        const rerunConnectivityTestMetadata = protoFilesRoot.lookup('.google.cloud.networkmanagement.v1.OperationMetadata');
        const deleteConnectivityTestResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteConnectivityTestMetadata = protoFilesRoot.lookup('.google.cloud.networkmanagement.v1.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.networkmanagement.v1.ReachabilityService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.reachabilityServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.networkmanagement.v1.ReachabilityService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.networkmanagement.v1.ReachabilityService, this._opts, this._providedCustomServicePath);
