...
class OrganizationVpcFlowLogsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.networkmanagement.v1.OrganizationVpcFlowLogsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.organizationVpcFlowLogsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.networkmanagement.v1.OrganizationVpcFlowLogsService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.networkmanagement.v1.OrganizationVpcFlowLogsService, this._opts, this._providedCustomServicePath);
