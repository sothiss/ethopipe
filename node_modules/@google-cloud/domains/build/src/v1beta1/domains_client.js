...
class DomainsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const registerDomainResponse = protoFilesRoot.lookup('.google.cloud.domains.v1beta1.Registration');
        const registerDomainMetadata = protoFilesRoot.lookup('.google.cloud.domains.v1beta1.OperationMetadata');
        const transferDomainResponse = protoFilesRoot.lookup('.google.cloud.domains.v1beta1.Registration');
        const transferDomainMetadata = protoFilesRoot.lookup('.google.cloud.domains.v1beta1.OperationMetadata');
        const updateRegistrationResponse = protoFilesRoot.lookup('.google.cloud.domains.v1beta1.Registration');
        const updateRegistrationMetadata = protoFilesRoot.lookup('.google.cloud.domains.v1beta1.OperationMetadata');
        const configureManagementSettingsResponse = protoFilesRoot.lookup('.google.cloud.domains.v1beta1.Registration');
        const configureManagementSettingsMetadata = protoFilesRoot.lookup('.google.cloud.domains.v1beta1.OperationMetadata');
        const configureDnsSettingsResponse = protoFilesRoot.lookup('.google.cloud.domains.v1beta1.Registration');
        const configureDnsSettingsMetadata = protoFilesRoot.lookup('.google.cloud.domains.v1beta1.OperationMetadata');
        const configureContactSettingsResponse = protoFilesRoot.lookup('.google.cloud.domains.v1beta1.Registration');
        const configureContactSettingsMetadata = protoFilesRoot.lookup('.google.cloud.domains.v1beta1.OperationMetadata');
        const exportRegistrationResponse = protoFilesRoot.lookup('.google.cloud.domains.v1beta1.Registration');
        const exportRegistrationMetadata = protoFilesRoot.lookup('.google.cloud.domains.v1beta1.OperationMetadata');
        const deleteRegistrationResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteRegistrationMetadata = protoFilesRoot.lookup('.google.cloud.domains.v1beta1.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.domains.v1beta1.Domains', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.domainsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.domains.v1beta1.Domains') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.domains.v1beta1.Domains, this._opts, this._providedCustomServicePath);
