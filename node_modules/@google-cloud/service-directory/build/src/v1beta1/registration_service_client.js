...
exports.RegistrationServiceClient = void 0;
 ...
 */
const gapicConfig = require("./registration_service_client_config.json");
...
class RegistrationServiceClient {
    ...
    _universeDomain;
    _servicePath;
    _log = google_gax_1.loggingUtils.log('service-directory');
    auth;
    descriptors = {
        page: {},
        stream: {},
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            endpointPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/namespaces/{namespace}/services/{service}/endpoints/{endpoint}'),
            locationPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}'),
            namespacePathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/namespaces/{namespace}'),
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.servicedirectory.v1beta1.RegistrationService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.registrationServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.servicedirectory.v1beta1.RegistrationService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.servicedirectory.v1beta1.RegistrationService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const registrationServiceStubMethods = ['createNamespace', 'listNamespaces', 'getNamespace', 'updateNamespace', 'deleteNamespace', 'createService', 'listServices', 'getService', 'updateService', 'deleteService', 'createEndpoint', 'listEndpoints', 'getEndpoint', 'updateEndpoint', 'deleteEndpoint', 'getIamPolicy', 'setIamPolicy', 'testIamPermissions'];
        for (const methodName of registrationServiceStubMethods) {
            const callPromise = this.registrationServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    createNamespace(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    getNamespace(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    updateNamespace(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    deleteNamespace(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
//# sourceMappingURL=registration_service_client.js.map