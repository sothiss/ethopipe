...
exports.LookupServiceClient = void 0;
 ...
 */
const gapicConfig = require("./lookup_service_client_config.json");
...
class LookupServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.servicedirectory.v1beta1.LookupService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.lookupServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.servicedirectory.v1beta1.LookupService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.servicedirectory.v1beta1.LookupService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const lookupServiceStubMethods = ['resolveService'];
        for (const methodName of lookupServiceStubMethods) {
            const callPromise = this.lookupServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    resolveService(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
...
exports.LookupServiceClient = LookupServiceClient;
//# sourceMappingURL=lookup_service_client.js.map