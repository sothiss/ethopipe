...
class HubServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createHubResponse = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1.Hub');
        const createHubMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1.OperationMetadata');
        const updateHubResponse = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1.Hub');
        const updateHubMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1.OperationMetadata');
        const deleteHubResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteHubMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1.OperationMetadata');
        const createSpokeResponse = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1.Spoke');
        const createSpokeMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1.OperationMetadata');
        const updateSpokeResponse = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1.Spoke');
        const updateSpokeMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1.OperationMetadata');
        const rejectHubSpokeResponse = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1.RejectHubSpokeResponse');
        const rejectHubSpokeMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1.OperationMetadata');
        const acceptHubSpokeResponse = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1.AcceptHubSpokeResponse');
        const acceptHubSpokeMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1.OperationMetadata');
        const acceptSpokeUpdateResponse = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1.AcceptSpokeUpdateResponse');
        const acceptSpokeUpdateMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1.OperationMetadata');
        const rejectSpokeUpdateResponse = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1.RejectSpokeUpdateResponse');
        const rejectSpokeUpdateMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1.OperationMetadata');
        const deleteSpokeResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteSpokeMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1.OperationMetadata');
        const updateGroupResponse = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1.Group');
        const updateGroupMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.networkconnectivity.v1.HubService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.hubServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.networkconnectivity.v1.HubService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.networkconnectivity.v1.HubService, this._opts, this._providedCustomServicePath);
