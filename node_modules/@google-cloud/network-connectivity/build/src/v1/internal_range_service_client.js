...
exports.InternalRangeServiceClient = void 0;
 ...
 */
const gapicConfig = require("./internal_range_service_client_config.json");
 ...
 * @memberof v1
 */
class InternalRangeServiceClient {
    _terminated = false;
    _opts;
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listInternalRanges: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'internalRanges')
        };
        ...
        const createInternalRangeResponse = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1.InternalRange');
        const createInternalRangeMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1.OperationMetadata');
        const updateInternalRangeResponse = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1.InternalRange');
        const updateInternalRangeMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1.OperationMetadata');
        const deleteInternalRangeResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteInternalRangeMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1.OperationMetadata');
        this.descriptors.longrunning = {
            createInternalRange: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createInternalRangeResponse.decode.bind(createInternalRangeResponse), createInternalRangeMetadata.decode.bind(createInternalRangeMetadata)),
            updateInternalRange: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateInternalRangeResponse.decode.bind(updateInternalRangeResponse), updateInternalRangeMetadata.decode.bind(updateInternalRangeMetadata)),
            deleteInternalRange: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteInternalRangeResponse.decode.bind(deleteInternalRangeResponse), deleteInternalRangeMetadata.decode.bind(deleteInternalRangeMetadata))
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.networkconnectivity.v1.InternalRangeService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.internalRangeServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.networkconnectivity.v1.InternalRangeService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.networkconnectivity.v1.InternalRangeService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const internalRangeServiceStubMethods = ['listInternalRanges', 'getInternalRange', 'createInternalRange', 'updateInternalRange', 'deleteInternalRange'];
        for (const methodName of internalRangeServiceStubMethods) {
            const callPromise = this.internalRangeServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getInternalRange(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    createInternalRange(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkCreateInternalRangeProgress(name) {
    ...
    updateInternalRange(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkUpdateInternalRangeProgress(name) {
    ...
    deleteInternalRange(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkDeleteInternalRangeProgress(name) {
    ...
    listInternalRanges(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   for more details and examples.
     */
    listInternalRangesStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listInternalRanges.createStream(this.innerApiCalls.listInternalRanges, request, callSettings);
    }
    /**
     ...
     */
    listInternalRangesAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listInternalRanges.asyncIterate(this.innerApiCalls['listInternalRanges'], request, callSettings);
    }
    /**
...
exports.InternalRangeServiceClient = InternalRangeServiceClient;
//# sourceMappingURL=internal_range_service_client.js.map