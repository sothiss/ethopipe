...
class PolicyBasedRoutingServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createPolicyBasedRouteResponse = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1.PolicyBasedRoute');
        const createPolicyBasedRouteMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1.OperationMetadata');
        const deletePolicyBasedRouteResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deletePolicyBasedRouteMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.networkconnectivity.v1.PolicyBasedRoutingService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.policyBasedRoutingServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.networkconnectivity.v1.PolicyBasedRoutingService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.networkconnectivity.v1.PolicyBasedRoutingService, this._opts, this._providedCustomServicePath);
