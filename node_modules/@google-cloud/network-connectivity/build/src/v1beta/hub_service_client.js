...
exports.HubServiceClient = void 0;
 ...
 */
const gapicConfig = require("./hub_service_client_config.json");
...
class HubServiceClient {
    ...
    _universeDomain;
    _servicePath;
    _log = google_gax_1.loggingUtils.log('networkconnectivity');
    auth;
    descriptors = {
        page: {},
        stream: {},
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            destinationPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/multicloudDataTransferConfigs/{multicloud_data_transfer_config}/destinations/{destination}'),
            gatewayAdvertisedRoutePathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/spokes/{spoke}/gatewayAdvertisedRoutes/{gateway_advertised_route}'),
            groupPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/global/hubs/{hub}/groups/{group}'),
            hubPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/global/hubs/{hub}'),
            hubRoutePathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/global/hubs/{hub}/routeTables/{route_table}/routes/{route}'),
            instancePathTemplate: new this._gaxModule.PathTemplate('projects/{project}/zones/{zone}/instances/{instance}'),
            interconnectAttachmentPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/regions/{region}/interconnectAttachments/{resource_id}'),
            locationPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}'),
            multicloudDataTransferConfigPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/multicloudDataTransferConfigs/{multicloud_data_transfer_config}'),
            multicloudDataTransferSupportedServicePathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/multicloudDataTransferSupportedServices/{multicloud_data_transfer_supported_service}'),
            networkPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/global/networks/{resource_id}'),
            policyBasedRoutePathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/global/PolicyBasedRoutes/{policy_based_route}'),
            remoteTransportProfilePathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/remoteTransportProfiles/{remote_transport_profile}'),
            routeTablePathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/global/hubs/{hub}/routeTables/{route_table}'),
            sACAttachmentPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/sacAttachments/{sac_attachment}'),
            spokePathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/spokes/{spoke}'),
            transportPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/transports/{transport}'),
            vpnTunnelPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/regions/{region}/vpnTunnels/{resource_id}'),
        };
        // Some of the methods on this service return "paged" results,
        // (e.g. 50 results at a time, with tokens to get subsequent
        // pages). Denote the keys used for pagination and results.
        this.descriptors.page = {
            listHubs: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'hubs'),
            listHubSpokes: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'spokes'),
            queryHubStatus: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'hubStatusEntries'),
            listSpokes: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'spokes'),
            listRoutes: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'routes'),
            listRouteTables: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'routeTables'),
            listGroups: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'groups'),
            listGatewayAdvertisedRoutes: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'gatewayAdvertisedRoutes')
        };
        ...
        const createHubResponse = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1beta.Hub');
        const createHubMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1beta.OperationMetadata');
        const updateHubResponse = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1beta.Hub');
        const updateHubMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1beta.OperationMetadata');
        const deleteHubResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteHubMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1beta.OperationMetadata');
        const createSpokeResponse = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1beta.Spoke');
        const createSpokeMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1beta.OperationMetadata');
        const updateSpokeResponse = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1beta.Spoke');
        const updateSpokeMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1beta.OperationMetadata');
        const rejectHubSpokeResponse = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1beta.RejectHubSpokeResponse');
        const rejectHubSpokeMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1beta.OperationMetadata');
        const acceptHubSpokeResponse = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1beta.AcceptHubSpokeResponse');
        const acceptHubSpokeMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1beta.OperationMetadata');
        const acceptSpokeUpdateResponse = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1beta.AcceptSpokeUpdateResponse');
        const acceptSpokeUpdateMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1beta.OperationMetadata');
        const rejectSpokeUpdateResponse = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1beta.RejectSpokeUpdateResponse');
        const rejectSpokeUpdateMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1beta.OperationMetadata');
        const deleteSpokeResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteSpokeMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1beta.OperationMetadata');
        const updateGroupResponse = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1beta.Group');
        const updateGroupMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1beta.OperationMetadata');
        const createGatewayAdvertisedRouteResponse = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1beta.GatewayAdvertisedRoute');
        const createGatewayAdvertisedRouteMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1beta.OperationMetadata');
        const updateGatewayAdvertisedRouteResponse = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1beta.GatewayAdvertisedRoute');
        const updateGatewayAdvertisedRouteMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1beta.OperationMetadata');
        const deleteGatewayAdvertisedRouteResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteGatewayAdvertisedRouteMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1beta.OperationMetadata');
        this.descriptors.longrunning = {
            createHub: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createHubResponse.decode.bind(createHubResponse), createHubMetadata.decode.bind(createHubMetadata)),
            updateHub: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateHubResponse.decode.bind(updateHubResponse), updateHubMetadata.decode.bind(updateHubMetadata)),
            deleteHub: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteHubResponse.decode.bind(deleteHubResponse), deleteHubMetadata.decode.bind(deleteHubMetadata)),
            createSpoke: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createSpokeResponse.decode.bind(createSpokeResponse), createSpokeMetadata.decode.bind(createSpokeMetadata)),
            updateSpoke: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateSpokeResponse.decode.bind(updateSpokeResponse), updateSpokeMetadata.decode.bind(updateSpokeMetadata)),
            rejectHubSpoke: new this._gaxModule.LongrunningDescriptor(this.operationsClient, rejectHubSpokeResponse.decode.bind(rejectHubSpokeResponse), rejectHubSpokeMetadata.decode.bind(rejectHubSpokeMetadata)),
            acceptHubSpoke: new this._gaxModule.LongrunningDescriptor(this.operationsClient, acceptHubSpokeResponse.decode.bind(acceptHubSpokeResponse), acceptHubSpokeMetadata.decode.bind(acceptHubSpokeMetadata)),
            acceptSpokeUpdate: new this._gaxModule.LongrunningDescriptor(this.operationsClient, acceptSpokeUpdateResponse.decode.bind(acceptSpokeUpdateResponse), acceptSpokeUpdateMetadata.decode.bind(acceptSpokeUpdateMetadata)),
            rejectSpokeUpdate: new this._gaxModule.LongrunningDescriptor(this.operationsClient, rejectSpokeUpdateResponse.decode.bind(rejectSpokeUpdateResponse), rejectSpokeUpdateMetadata.decode.bind(rejectSpokeUpdateMetadata)),
            deleteSpoke: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteSpokeResponse.decode.bind(deleteSpokeResponse), deleteSpokeMetadata.decode.bind(deleteSpokeMetadata)),
            updateGroup: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateGroupResponse.decode.bind(updateGroupResponse), updateGroupMetadata.decode.bind(updateGroupMetadata)),
            createGatewayAdvertisedRoute: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createGatewayAdvertisedRouteResponse.decode.bind(createGatewayAdvertisedRouteResponse), createGatewayAdvertisedRouteMetadata.decode.bind(createGatewayAdvertisedRouteMetadata)),
            updateGatewayAdvertisedRoute: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateGatewayAdvertisedRouteResponse.decode.bind(updateGatewayAdvertisedRouteResponse), updateGatewayAdvertisedRouteMetadata.decode.bind(updateGatewayAdvertisedRouteMetadata)),
            deleteGatewayAdvertisedRoute: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteGatewayAdvertisedRouteResponse.decode.bind(deleteGatewayAdvertisedRouteResponse), deleteGatewayAdvertisedRouteMetadata.decode.bind(deleteGatewayAdvertisedRouteMetadata))
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.networkconnectivity.v1beta.HubService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.hubServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.networkconnectivity.v1beta.HubService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.networkconnectivity.v1beta.HubService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of hubServiceStubMethods) {
            const callPromise = this.hubServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getHub(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    getSpoke(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    getRouteTable(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    getGatewayAdvertisedRoute(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    createHub(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkCreateHubProgress(name) {
    ...
    updateHub(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkUpdateHubProgress(name) {
    ...
    deleteHub(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkDeleteHubProgress(name) {
    ...
    createSpoke(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkCreateSpokeProgress(name) {
    ...
    updateSpoke(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkUpdateSpokeProgress(name) {
    ...
    rejectHubSpoke(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkRejectHubSpokeProgress(name) {
    ...
    acceptHubSpoke(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkAcceptHubSpokeProgress(name) {
    ...
    acceptSpokeUpdate(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkAcceptSpokeUpdateProgress(name) {
    ...
    rejectSpokeUpdate(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkRejectSpokeUpdateProgress(name) {
    ...
    deleteSpoke(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkDeleteSpokeProgress(name) {
     ...
     */
    async checkUpdateGroupProgress(name) {
    ...
    createGatewayAdvertisedRoute(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkCreateGatewayAdvertisedRouteProgress(name) {
    ...
    updateGatewayAdvertisedRoute(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkUpdateGatewayAdvertisedRouteProgress(name) {
    ...
    deleteGatewayAdvertisedRoute(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkDeleteGatewayAdvertisedRouteProgress(name) {
    ...
    listHubs(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listHubsStream(request, options) {
        ...
        return this.descriptors.page.listHubs.createStream(this.innerApiCalls.listHubs, request, callSettings);
    }
    /**
    ...
    listHubsAsync(request, options) {
        ...
        return this.descriptors.page.listHubs.asyncIterate(this.innerApiCalls['listHubs'], request, callSettings);
    }
    listHubSpokes(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listHubSpokesStream(request, options) {
        ...
        return this.descriptors.page.listHubSpokes.createStream(this.innerApiCalls.listHubSpokes, request, callSettings);
    }
    /**
    ...
    listHubSpokesAsync(request, options) {
        ...
        return this.descriptors.page.listHubSpokes.asyncIterate(this.innerApiCalls['listHubSpokes'], request, callSettings);
    }
    queryHubStatus(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    queryHubStatusStream(request, options) {
        ...
        return this.descriptors.page.queryHubStatus.createStream(this.innerApiCalls.queryHubStatus, request, callSettings);
    }
    /**
    ...
    queryHubStatusAsync(request, options) {
        ...
        return this.descriptors.page.queryHubStatus.asyncIterate(this.innerApiCalls['queryHubStatus'], request, callSettings);
    }
    listSpokes(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listSpokesStream(request, options) {
        ...
        return this.descriptors.page.listSpokes.createStream(this.innerApiCalls.listSpokes, request, callSettings);
    }
    /**
    ...
    listSpokesAsync(request, options) {
        ...
        return this.descriptors.page.listSpokes.asyncIterate(this.innerApiCalls['listSpokes'], request, callSettings);
    }
    listRoutes(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listRoutesStream(request, options) {
        ...
        return this.descriptors.page.listRoutes.createStream(this.innerApiCalls.listRoutes, request, callSettings);
    }
    /**
    ...
    listRoutesAsync(request, options) {
        ...
        return this.descriptors.page.listRoutes.asyncIterate(this.innerApiCalls['listRoutes'], request, callSettings);
    }
    listRouteTables(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listRouteTablesStream(request, options) {
        ...
        return this.descriptors.page.listRouteTables.createStream(this.innerApiCalls.listRouteTables, request, callSettings);
    }
    /**
    ...
    listRouteTablesAsync(request, options) {
        ...
        return this.descriptors.page.listRouteTables.asyncIterate(this.innerApiCalls['listRouteTables'], request, callSettings);
    }
    ...
    listGatewayAdvertisedRoutes(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   for more details and examples.
     */
    listGatewayAdvertisedRoutesStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listGatewayAdvertisedRoutes.createStream(this.innerApiCalls.listGatewayAdvertisedRoutes, request, callSettings);
    }
    /**
     ...
     */
    listGatewayAdvertisedRoutesAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listGatewayAdvertisedRoutes.asyncIterate(this.innerApiCalls['listGatewayAdvertisedRoutes'], request, callSettings);
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    gatewayAdvertisedRoutePath(project, location, spoke, gatewayAdvertisedRoute) {
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromGatewayAdvertisedRouteName(gatewayAdvertisedRouteName) {
     ...
     * @returns {string} A string representing the location.
     */
    matchLocationFromGatewayAdvertisedRouteName(gatewayAdvertisedRouteName) {
     ...
     */
    matchSpokeFromGatewayAdvertisedRouteName(gatewayAdvertisedRouteName) {
     ...
     */
    matchGatewayAdvertisedRouteFromGatewayAdvertisedRouteName(gatewayAdvertisedRouteName) {
     ...
     * @returns {string} Resource name string.
     */
    remoteTransportProfilePath(project, location, remoteTransportProfile) {
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromRemoteTransportProfileName(remoteTransportProfileName) {
     ...
     * @returns {string} A string representing the location.
     */
    matchLocationFromRemoteTransportProfileName(remoteTransportProfileName) {
     ...
     */
    matchRemoteTransportProfileFromRemoteTransportProfileName(remoteTransportProfileName) {
     ...
     * @returns {string} Resource name string.
     */
    transportPath(project, location, transport) {
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromTransportName(transportName) {
     ...
     * @returns {string} A string representing the location.
     */
    matchLocationFromTransportName(transportName) {
     ...
     */
    matchTransportFromTransportName(transportName) {
...
exports.HubServiceClient = HubServiceClient;
//# sourceMappingURL=hub_service_client.js.map