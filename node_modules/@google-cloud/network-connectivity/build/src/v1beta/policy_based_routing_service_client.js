...
exports.PolicyBasedRoutingServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta/policy_based_routing_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./policy_based_routing_service_client_config.json");
...
class PolicyBasedRoutingServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listPolicyBasedRoutes: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'policyBasedRoutes')
        };
        ...
        const createPolicyBasedRouteResponse = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1beta.PolicyBasedRoute');
        const createPolicyBasedRouteMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1beta.OperationMetadata');
        const deletePolicyBasedRouteResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deletePolicyBasedRouteMetadata = protoFilesRoot.lookup('.google.cloud.networkconnectivity.v1beta.OperationMetadata');
        this.descriptors.longrunning = {
            createPolicyBasedRoute: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createPolicyBasedRouteResponse.decode.bind(createPolicyBasedRouteResponse), createPolicyBasedRouteMetadata.decode.bind(createPolicyBasedRouteMetadata)),
            deletePolicyBasedRoute: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deletePolicyBasedRouteResponse.decode.bind(deletePolicyBasedRouteResponse), deletePolicyBasedRouteMetadata.decode.bind(deletePolicyBasedRouteMetadata))
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.networkconnectivity.v1beta.PolicyBasedRoutingService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.policyBasedRoutingServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.networkconnectivity.v1beta.PolicyBasedRoutingService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.networkconnectivity.v1beta.PolicyBasedRoutingService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of policyBasedRoutingServiceStubMethods) {
            const callPromise = this.policyBasedRoutingServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getPolicyBasedRoute(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    createPolicyBasedRoute(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     * @example <caption>include:samples/generated/v1beta/policy_based_routing_service.create_policy_based_route.js</caption>
     * region_tag:networkconnectivity_v1beta_generated_PolicyBasedRoutingService_CreatePolicyBasedRoute_async
     */
    async checkCreatePolicyBasedRouteProgress(name) {
    ...
    deletePolicyBasedRoute(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1beta/policy_based_routing_service.delete_policy_based_route.js</caption>
     * region_tag:networkconnectivity_v1beta_generated_PolicyBasedRoutingService_DeletePolicyBasedRoute_async
     */
    async checkDeletePolicyBasedRouteProgress(name) {
    ...
    listPolicyBasedRoutes(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.cloud.networkconnectivity.v1beta.PolicyBasedRoute|PolicyBasedRoute} on 'data' event.
    ...
    listPolicyBasedRoutesStream(request, options) {
        ...
        return this.descriptors.page.listPolicyBasedRoutes.createStream(this.innerApiCalls.listPolicyBasedRoutes, request, callSettings);
    }
    /**
     ...
     *   {@link protos.google.cloud.networkconnectivity.v1beta.PolicyBasedRoute|PolicyBasedRoute}. The API will be called under the hood as needed, once per the page,
     *   so you can stop the iteration when you don't need more results.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1beta/policy_based_routing_service.list_policy_based_routes.js</caption>
     * region_tag:networkconnectivity_v1beta_generated_PolicyBasedRoutingService_ListPolicyBasedRoutes_async
     */
    listPolicyBasedRoutesAsync(request, options) {
        ...
        return this.descriptors.page.listPolicyBasedRoutes.asyncIterate(this.innerApiCalls['listPolicyBasedRoutes'], request, callSettings);
    }
    /**
...
exports.PolicyBasedRoutingServiceClient = PolicyBasedRoutingServiceClient;
//# sourceMappingURL=policy_based_routing_service_client.js.map